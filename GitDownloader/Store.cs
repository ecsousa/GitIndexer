...
namespace Git.Credential.WinStore
{
    class Store
    {
        public static IEnumerable<Tuple<string, string>> GetCommand(Uri url)
        {
            if (url == null)
            {
                yield break;
        ...
        public static IEnumerable<Tuple<string, string>> StoreCommand(IDictionary<string, string> args)
        {
            // Build the URL
        ...
        public static IEnumerable<Tuple<string, string>> EraseCommand(IDictionary<string, string> args)
        {
            var url = ExtractUrl(args);
